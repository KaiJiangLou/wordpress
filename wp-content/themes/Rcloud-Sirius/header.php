...
<![endif]-->
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?php bloginfo( 'template_url' ); ?>/images/favicon1.ico" />
	<!--KEY-->
...
<div id="header"><div class="wrap">
	<!-- logo -->
	<div class="logo">
		<a class="logolink" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>">
